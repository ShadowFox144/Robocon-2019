...
float Kp[4][2] = {{4.5, 4.5}, {15.0, 15.0}, {4.5, 4.5}, {4.5, 4.5}}, Kd[4][2] = {{0, 0}, {10.0, 10.0}, {0, 0}, {0, 0}}, Ki[4][2] = {{0, 0}, {0, 0}, {0, 0}, {0, 0}};
...
void loop()
{
  for (int i = 0; i < 48; i++)
  {
    ...
    {
      set_position[0][0] = -theta_1[82 - i] - 270;
      set_position[0][1] = 540 - theta_2[82 - i];
      set_position[1][0] = -theta_1[71 - i] - 270;
      set_position[1][1] = 540 - theta_2[71 - i];
      set_position[2][0] = -theta_1[82 - i] - 270;
      set_position[2][1] = 540 - theta_2[82 - i];
      set_position[3][0] = -theta_1[47 - i] - 270;
      set_position[3][1] = 540 - theta_2[47 - i];
    }
...
void cal_PID()
{
  for (int i = 0; i < 4; i++)
  {
    for (int j = 0; j < 2; j++)
    {
      float encoderValueScam = encoderValue[i][j] / 6.162;
      error[i][j] = set_position[i][j] - encoderValueScam;//encoderValue[i][j];
