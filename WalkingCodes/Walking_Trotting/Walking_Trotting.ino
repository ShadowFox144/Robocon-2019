...
int theta_2[48] = { -3763, -3632, -3501, -3371, -2986, -2858, -2731, -2603, -2476, -2349, -2221, -2094, -1967, -1841, -1714, -1589, -1464, -1339, -1216, -1095, -974, -856, -739, -625, -513, -403, -297, -194, -94, 2, 94, 184, 269, 350, 427, 500, 568, 633, 693, 749, 801, 849, 893, 933, 1735, 2233, -260, -2865};
//theta_1 - right
//theta_2 - left
int theta_1[48] = {933, 893, 849, 801, 749, 693, 633, 568, 500, 427, 350, 269, 184, 94, 2, -94, -194, -297, -403, -513, -625, -739, -856, -974, -1095, -1216, -1339, -1464, -1589, -1714, -1841, -1967, -2094, -2221, -2349, -2476, -2603, -2731, -2858, -2986, -3371, -3501, -3632, -3763, -2865, -260, 2233, 1735};
...
void setup() {
  ...
  set_position[2][0] = theta_1[23];
  set_position[2][1] = theta_2[23];
  set_position[3][0] = theta_1[0];
  set_position[3][1] = theta_2[0];
...
void loop()
{
  for (int i = 0; i < 48; i++)
  {
    ...
    if (i < 24)
    {
      set_position[0][0] = theta_1[i];
      set_position[0][1] = theta_2[i];
      set_position[1][0] = theta_1[i + 24];
      set_position[1][1] = theta_2[i + 24];
      set_position[2][0] = theta_1[i + 24];
      set_position[2][1] = theta_2[i + 24];
      set_position[3][0] = theta_1[i];
      set_position[3][1] = theta_2[i];
    }
    else
    {
      set_position[0][0] = theta_1[i];
