...
//Leg 0
//Leg 0
int outputA[2] = {A13, A15};
int outputB[2] = {A12, A14};

//Leg 2
//Leg 2
int outputA_1[2] = {11, 51};
int outputB_1[2] = {13, 53};

//Leg 0
uint8_t motor_pin[2] = {7, 8};
uint8_t dir_pin[2] = {40, 48};

//Leg 2
uint8_t motor_pin_1[2] = {2, A5};
uint8_t dir_pin_1[2] = {9, A0};
