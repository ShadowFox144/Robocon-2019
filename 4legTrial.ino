...
int fwd[4] = {{1,-1},{1,-1},{1,-1},{1,-1}};
int rev[4] = {{-1,1},{-1,1},{-1,1},{-1,1}};
int left[4] = {{1,-1},{1,-1},{1,-1},{1,-1}};
int right[4] = {{1,-1},{1,-1},{1,-1},{1,-1}};

volatile int lastEncoded[4][2] = {0, 0}, sum[4][2] = {0, 0}, encoded[4][2] = {0, 0}, MSB[4][2] = {0, 0}, LSB[4][2] = {0, 0};
...
int set_position[4][2] = {{ -1080, 1080}, { -1080, 1080},{ -1080, 1080}, { -1080, 1080}};

float Kp[4][2] = {{4.5, 4.5}, {4.5, 4.5},{4.5, 4.5}, {4.5, 4.5}}, Kd[4][2] = {{0, 0}, {0, 0},{0, 0}, {0, 0}}, Ki[2][2] = {{0, 0}, {0, 0},{0, 0}, {0, 0}};
...
void setup() {
  ...
  //  }
  //
  set_position[0][0] = -theta_1[24] - 270;
  set_position[0][1] = 540 - theta_2[24];
  set_position[1][0] = -theta_1[49] - 270;
  set_position[1][1] = 540 - theta_2[49];

  //To be modified
  set_position[2][0] = -theta_1[24] - 270;
  set_position[2][1] = 540 - theta_2[24];
  set_position[3][0] = -theta_1[49] - 270;
  set_position[3][1] = 540 - theta_2[49];
...
void loop(){ // To be Modified
  for (int i = 0; i < 50; i++){

    last_ms = millis();

    if (i < 25){
      set_position[0][0] = -theta_1[24 - i] - 270;
      set_position[0][1] = 540 - theta_2[24 - i];
      set_position[1][0] = -theta_1[49 - i] - 270;
      set_position[1][1] = 540 - theta_2[49 - i];
      ...
      set_position[0][0] = -theta_1[74-i] - 270;
      set_position[0][1] = 540 - theta_2[74-i];
      set_position[1][0] = -theta_1[49 - i] - 270;
      set_position[1][1] = 540 - theta_2[49 - i];
      //To be Modified
      set_position[0][0] = -theta_1[74-i] - 270;
...
void motors(float motor_speed[4][2], int dir[4][2]) { // To be Modified
  for (int j = 0; j < 2; j++)
  {
  ...
  // for (int i = 0; i < 4; i++)
  //   for (int j = 0; j < 2; j++)
  //     set_motor(i, j, dir[i][j] * motor_speed[i][j]);
}
...
void encode_2_0() {
  ...
  encoded[2][0] = (MSB[2][0] << 2) 0 LSB[2][0]; //converting the 2 pin value to single number
